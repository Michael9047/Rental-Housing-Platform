...
class SynthesizerAgent(BaseAgent):
    ...
    STAGE_TONES: dict[str, str] = {
        "explore": "用户刚开始探索。给市场快照：这一带有多少房源、价格区间。引导细化条件（预算？通勤？独卫？）。例如「园区这边单间1500-2500都有，合租800起。你预算多少？要独卫吗？」",
        "calibrate": "用户正在了解行情。解释价位差异（便宜=远/合租 vs 贵=近/独卫）。帮建立预算预期。例如「文星1500以内基本是合租，单间独卫要1800+，这是园区这边的行情」",
        "narrow": "用户已明确条件。逐套分析匹配度，突出差异化优势。给出明确排序。例如「这3套里翰林缘通勤最近，文星价格最低但面积小，文荟性价比居中——我个人推荐翰林缘」",
        "compare": "用户在做最终决定。直接推荐+理由，指出每套 trade-off。语气果断。例如「果断翰林缘。虽然贵了200，但每天多睡20分钟+独卫，值这个差价」",
        "decide": "用户已接近决定。确认选择+强调优势+引导下一步。例如「翰林缘是对的！步行10分钟到FB，楼下就有食堂和便利店。要预约看房吗？」",
        "general": "西交利物浦周边租房顾问。口语化中文，简洁友好。例如「嗨！想在学校附近租房？告诉我预算和需求，我帮你筛～」",
    }
