...
{{"district": null 或 "新区域", "price_min": null 或 新最低价(整数), "price_max": null 或 新最高价(整数), "bedrooms": null 或 新卧室数(整数), "property_type": null 或 "studio/1-bed/2-bed/shared/house", "reasoning": "改写理由"}}
