...
from app.api.v1.routes import admin, auth, bookings, chat, contracts, geocoding, health, images, imports, map_routes, notifications, payments, pois, properties, users, wechat
