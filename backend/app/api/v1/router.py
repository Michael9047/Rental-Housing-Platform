...
from app.api.v1.routes import admin, ai_search, auth, bookings, buildings, chat, contracts, favorites, geocoding, health, images, imports, map_routes, ml, notifications, payments, pois, properties, upload, users, wechat
