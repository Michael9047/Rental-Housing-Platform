...
async def search_properties(
    ...
    return [
        PropertySearchResult(
            ...
            service_fee_rate=prop.service_fee_rate,
            min_lease_months=prop.min_lease_months,
            max_lease_months=prop.max_lease_months,
            rent_type=prop.rent_type,
            room_number=prop.room_number,
            floor=prop.floor,
            amenities=prop.amenities,
            available_from=prop.available_from,
            min_stay_months=prop.min_stay_months,
            deposit_type=prop.deposit_type,
            special_offer=getattr(prop, 'special_discount', None),
