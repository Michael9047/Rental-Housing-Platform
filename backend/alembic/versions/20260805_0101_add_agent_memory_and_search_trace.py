...
与 PR #43 原版的差异：
- property_id FK 从 properties.id 改为 unit_types.id（HEAD 已删除 properties 表）
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        # HEAD 已删除 properties 表，property_id 指向 unit_types
        ...
        sa.ForeignKeyConstraint(["property_id"], ["unit_types.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
