...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'workspace/workers', name: 'landlord-workers', component: () => import('@/views/landlord/WorkerManagement.vue'), meta: { requiresAuth: true, requiresLandlord: true } },
      { path: 'worker/dashboard', name: 'worker-dashboard', component: () => import('@/views/maintenance/WorkerDashboard.vue'), meta: { requiresAuth: true, requiresMaintenance: true } },
      { path: 'worker/orders', name: 'worker-orders', component: () => import('@/views/maintenance/WorkerOrders.vue'), meta: { requiresAuth: true, requiresMaintenance: true } },
      ...
      { path: 'admin/escalated-repairs', name: 'admin-escalated-repairs', component: () => import('@/views/admin/EscalatedRepairs.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: 'admin/landlord-workers', name: 'admin-landlord-workers', component: () => import('@/views/admin/LandlordWorkersStatus.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
