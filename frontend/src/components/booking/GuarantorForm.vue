<template>
  <div class="guarantor-form">
    <h3 class="form-section-title">担保人信息</h3>
    <el-form :model="form" label-position="top" class="info-form">
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="中文姓名" prop="chinese_name">
            <el-input v-model="form.chinese_name" placeholder="一般为承租人的父母、法定监护人或近亲" @blur="validateField('chinese_name')" />
      ...
      <el-row :gutter="16">
        ...
        <el-col :span="12">
          <el-form-item label="与申请人的关系" prop="relation">
            <el-select v-model="form.relation" placeholder="请选择担保人与申请人的关系" style="width: 100%" @change="validateField('relation')">
      ...
      <el-row :gutter="16">
        ...
        <el-col :span="12">
          <el-form-item label="手机号" prop="phone">
            <el-input v-model="form.phone" placeholder="请填写担保人手机号" @blur="validateField('phone')">
      ...
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="邮箱" prop="email">
            <el-input v-model="form.email" placeholder="请确保邮箱可以正常收发邮件" @blur="validateField('email')" />
            <div class="hint-text">担保人邮箱需真实有效，且不能与个人邮箱一致（否则会影响预订）</div>
    ...
    <h3 class="form-section-title">
      担保人地址
      <el-checkbox v-model="sameAsApplicant" class="same-checkbox" @change="onSameAsApplicantChange">
        与"个人地址"信息相同？
      </el-checkbox>
    </h3>
    <el-form :model="form" label-position="top" class="info-form">
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="所在地区" prop="region">
            ...
            <el-select
              ...
              placeholder="请选择省份"
              style="width: 100%; margin-bottom: 8px"
              :disabled="sameAsApplicant || !selectedCountry || !showProvince"
            ...
            <el-select
              ...
              placeholder="请选择城市"
              style="width: 100%; margin-bottom: 8px"
              :disabled="sameAsApplicant || !selectedCountry || (showProvince && !selectedProvince)"
              @change="onCityChange"
            >
            ...
            <el-select
              ...
              placeholder="请选择区/县"
              style="width: 100%"
              :disabled="sameAsApplicant || !selectedCity || !showDistrict"
        ...
        <el-col :span="12">
          <el-form-item label="联系地址" prop="address_detail">
            <el-input v-model="form.address_detail" placeholder="请填写包括城区、街道、小区在内的详细地址" :disabled="sameAsApplicant" @blur="validateField('address_detail')" />
      ...
      <el-row :gutter="16">
        <el-col :span="12">
          <el-form-item label="邮政编码" prop="postal_code">
            <el-input v-model="form.postal_code" placeholder="请填写邮编，如&quot;100001&quot;" :disabled="sameAsApplicant" @blur="validateField('postal_code')" />
...
const form = computed({
  get: () => bookingFlow.guarantor,
  set: (val) => {
    Object.assign(bookingFlow.guarantor, val)
...
function onSameAsApplicantChange(val: boolean) {
  if (val) {
    const applicant = bookingFlow.applicant
    form.value.region = applicant.region
    form.value.address_detail = applicant.address_detail
    form.value.postal_code = applicant.postal_code
    form.value.same_as_applicant = true

    const { country, province, city, district } = parseRegion(applicant.region)
    selectedCountry.value = country
    selectedProvince.value = province
    selectedCity.value = city
    selectedDistrict.value = district
  } else {
    form.value.same_as_applicant = false
  }
}
...
onMounted(() => {
  ...
  if (form.value.same_as_applicant) {
    sameAsApplicant.value = true
  }
})
